...
export const HeroSection = () => {
  return (
    <section className="relative min-h-screen w-full flex flex-col justify-center items-center text-center px-4 overflow-hidden">
      ...
      {/* Main Content - a fusion of our best design and copy */}
      <motion.div
        initial="hidden"
        animate="visible"
        viewport={{ once: true }}
      ...
      >
        <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="mb-8">
            {/* Ensure your banner is named 'wise-banner.png' in /public/media/ */}
            <Image 
              src="/media/wise-banner.png" 
      ...
      >
        <div className="w-6 h-10 border-2 border-text-tertiary rounded-full flex justify-center p-1">
          <motion.div 
